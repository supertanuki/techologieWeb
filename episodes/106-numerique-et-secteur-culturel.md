...
transcribed: true
tags: ["culture", "design", "réemploi", "déconnexion", "souveraineté", "géopolitique"]
---
...
- Les Augures et l'Augures Lab
- Quels sont pour toi les défis d'un numérique plus soutenable dans le domaine culturel en tant que designer ?
...
- [Stratégie numérique responsable du ministère de la Culture](https://www.culture.gouv.fr/thematiques/transition-ecologique/strategie-numerique-responsable-du-ministere-de-la-culture)
- [Le dispositif Augures Lab](https://www.culture.gouv.fr/thematiques/transition-ecologique/le-dispositif-augures-lab-un-programme-pour-un-numerique-responsable-dans-la-culture)
- [Les Augures](https://lesaugures.com/)
...
<p class="quote-author">— Camille Pène</p>
</blockquote>
...
<p class="quote-author">— Romane Clément</p>
</blockquote>
...
<p class="quote-author">— Christine Debray</p>
</blockquote>
...
- Non, ça reste un Dark Pattern, c'est juste une surcouche de couleurs.
- Un seul mot
- Ah pardon, pardon.
...
- (Rires)
- Non, c'est pas ça, c'est pas ça. Attention, c'est hyper long, tu es concentrée ?
...
- Ni l'un ni l'autre, réemployer dans le secteur social et solidaire.
- Elle a hacké le truc.
- Aucune n'était bonne, envoyer, on n'a même plus le droit.
...
- Bonjour à HOP en passant, non. Je suis bien ou je suis, désolée.
- Merci beaucoup. On referme cette séquence humoristique. Les réponses, on est d'accord, n'engagent pas votre employeur ou vos collègues. On va revenir sur des choses plus sérieuses ou pas, d'ailleurs.
...
On a financé aussi, effectivement, ce jeu vidéo ([Trois-Rivières](https://www.trois-rivieres.net/)). Il est trop cool parce qu'il est low-tech et il expose vraiment l'ensemble du cycle de vie et les impacts, à la fois écologiques et humains, de l'ensemble du cycle de vie d'un matériel numérique.
